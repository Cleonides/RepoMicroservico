...
#Precisa atualizar a versão do docker-compose atual(v2.28.1):<br />
2.1 - Se for Linux : <br/>
...
3-Após subir aplicação esse é o endereço : http://localhost:8080/  ou http://0.0.0.0.:8080/ <br/>
Aparece a mensagem : Server in the air, time (Servidor no ar, horário)+ horário da máquina.<br/>
...
GET DEFAULT - http://localhost:/ <br/>
  #Servidor no ar, horário :18/08/2024 01:42:01#<br/>
